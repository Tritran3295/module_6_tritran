...
public class BenXe {
    ...
    public BenXe(int id, Integer soXe, String loaiXe, String tenNhaXe, String soDienThoai, String email, String gioDi, String gioDen, DiemDen diemDen, DiemDi diemDi) {
        this.id = id;
        this.soXe = soXe;
        this.loaiXe = loaiXe;
